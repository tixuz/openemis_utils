...
if driver is not None:
    ...
    if is_core_present == 1:
        for institution_code in institution_codes:
            institution_encoded_link = get_institution_encoded_link(institution_code, core_url, driver)
            if institution_encoded_link != "":
                for shift in shifts:
                    add_shift_to_institution(institution_encoded_link, shift, core_url,  driver)
